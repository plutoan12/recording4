...
export type WorkflowDraft = {source_asset_id:string; start:number; end:number; mode:string; focus_x:number;
  title:string; burn_subtitles?:boolean; caption_language?:string; subtitle_template?:string; subtitle_animation?:string; subtitle_preset?:string; subtitle_pacing?:string; stickers?:unknown[]; cues:{start:number;end:number;text:string}[]}
