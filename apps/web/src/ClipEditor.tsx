  ...
  return <section className="clip-editor">
    ...
    {assetId && <>
      ...
      <details>
        ...
        <p><b>통째로 옮기기</b>가 기본입니다. 빠르지만 이동값이 하나뿐이라 문장마다 다르게 어긋났거나 말 속도가 달라진 자막은 원리상 맞출 수 없습니다(측정: 1.25배 빠른 말에서 0.50초). <b>단어 정렬</b>은 대본 글자를 음성에 하나씩 맞춰 자막마다 시각을 따로 찾으므로 그런 경우를 다룰 수 있지만, 음성 인식 모델을 돌려 훨씬 느리고 <b>한국어 낭독 측정에서 통째로 옮기기보다 나빴습니다</b>(조건 세 가지에서 1.63~3.10초, 통째로 옮기기는 0.03~0.50초). 지금은 권하지 않습니다. 글자가 실제 발화와 다른 번역 자막에는 통째로 옮기기만 됩니다. 어느 쪽이든 결과는 대본 새 버전이라 되돌릴 수 있습니다.</p>
