...
BUILTIN_TEMPLATES: dict[str, SubtitleTemplate] = {
    ...
    for t in (
        ...
        # ---- 참고 팩 글꼴 ------------------------------------------------
        # 에스코어드림·나눔스퀘어라운드·티몬·스웨거·SUIT·배민·온글잎·메이플·넥슨.
        _builtin(
            name="scoredream-clean",
            label="에스코어드림 깔끔",
            description="에스코어 드림 6 Bold 흰 글자에 얇은 외곽선. 브이로그 기본 자막.",
            sample="오늘은 성수동 카페 투어",
            category="basic",
            font_name="S-Core Dream 6 Bold",
            font_size=60,
            outline=2,
            shadow=0,
        ),
        _builtin(
            name="nexon-info",
            label="넥슨 고딕 정보",
            description="넥슨 Lv1 고딕 흰 글자에 남회색 외곽선. 정보·설명 자막.",
            sample="위치: 서울숲역 4번 출구",
            category="basic",
            font_name="NEXON Lv1 Gothic OTF",
            font_size=58,
            outline_color="#2B3A4A",
            outline=3,
            shadow=0,
        ),
        _builtin(
            name="scoredream-heavy-yellow",
            label="에스코어드림 노랑",
            description="에스코어 드림 8 Heavy 노란 글자에 검은 외곽선. 예능 강조.",
            sample="이게 무슨 일이야?!",
            category="vlog",
            font_name="S-Core Dream 8 Heavy",
            font_size=80,
            primary_color="#FFE14D",
            outline_color="#111111",
            outline=4,
        ...
        _builtin(
            name="tmon-shout",
            label="몬소리 외침",
            description="티몬 몬소리 흰 글자에 빨간 바깥선. 소리치는 자막.",
            sample="대박!!! 진짜???",
            category="vlog",
            font_name="TmonMonsori",
            font_size=88,
            outline_color="#111111",
            outline=3,
            outline2=3,
            outline2_color="#E8342B",
            shadow=0,
        ),
        _builtin(
            name="hanna-orange",
            label="한나체 주황",
            description="배민 한나체 Pro 주황 글자에 흰 외곽선과 검은 바깥선. 광고 카피 느낌.",
            sample="치킨은 역시 후라이드",
            category="vlog",
            ...
            outline=3,
            outline2=2,
            outline2_color="#222222",
            shadow=0,
        ),
        _builtin(
            name="nanum-round-mint",
            label="나눔스퀘어라운드 민트",
            description="나눔스퀘어라운드 민트 글자에 흰 외곽선과 진초록 바깥선. 둥글둥글 스티커.",
            sample="셀프 네일 완성 ♡",
            category="cute",
            font_name="NanumSquareRound",
            font_size=76,
            bold=True,
            primary_color="#7FE3C6",
            outline_color="#FFFFFF",
            outline=4,
            outline2=2,
            outline2_color="#1B6B52",
            shadow=0,
        ),
        _builtin(
            name="maple-game",
            label="메이플 게임 대사",
            description="메이플스토리 굵은 노란 글자에 갈색 외곽선. 게임 퀘스트 창처럼.",
            sample="퀘스트 완료! 경험치 +100",
            category="pixel",
            font_name="Maplestory",
            font_size=64,
            primary_color="#FFE680",
            outline_color="#5A3A12",
            outline=3,
            shadow=0,
        ),
        _builtin(
            name="suit-dark-card",
            label="수트 검은 카드",
            description="SUIT 굵은 흰 글자를 반투명 검은 둥근 카드에. 인터뷰·정보 자막.",
            sample="Q. 요즘 가장 힘든 점은?",
            category="box",
            font_name="SUIT",
            font_size=52,
            bold=True,
        ...
        _builtin(
            name="moogung-handwriting",
            label="온글잎 무궁 손글씨",
            description="온글잎 무궁체 흰 손글씨에 얇은 외곽선, 핑크 강조.",
            sample="오늘의 [[다짐]]: 일찍 자기",
            category="handwriting",
            font_name="Ownglyph MoogungChae",
            font_size=92,
            outline=2,
            shadow=0,
            accent_color="#FF7AB8",
        ...
        _builtin(
            name="swagger-street",
            label="스웨거 스트리트",
            description="스웨거체 흰 글자에 검은 외곽선, 자간 넓게. 힙합·스트리트 느낌.",
            sample="SWAG CHECK",
            category="retro",
            font_name="Swagger TTF",
            font_size=84,
            outline=3,
            shadow=2,
            letter_spacing=3,
        ...
        _builtin(
            name="euljiro-sign",
            label="을지로 간판",
            description="배민 을지로오래오래체 크림 글자를 진초록 상자에. 옛 간판 느낌.",
            sample="노포 맛집 탐방",
            category="retro",
            font_name="BM Euljiro oraeorae",
            font_size=72,
            primary_color="#FFF3D6",
            border_style="box",
            box_color="#1F4D3A",
            outline=6,
            shadow=0,
...
FONT_WIDTH_FACTORS: dict[str, float] = {
    ...
    "Pretendard": 1.0,
    "Wanted Sans": 1.0,
    "S-Core Dream 6 Bold": 1.0,
    "S-Core Dream 8 Heavy": 1.02,
    "NanumSquareRound": 0.95,
    "TmonMonsori": 1.05,
    "Swagger TTF": 0.95,
    "SUIT": 1.0,
    "BM HANNA Pro": 0.95,
    "BM Euljiro oraeorae": 0.95,
    "Ownglyph MoogungChae": 0.85,
    "Maplestory": 1.0,
    "NEXON Lv1 Gothic OTF": 1.0,
}
