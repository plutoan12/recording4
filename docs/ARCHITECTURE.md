...
- 글자 수는 폭으로 셉니다. 한글·한자·가나는 1자, 라틴 문자·숫자·공백·문장부호는 0.5자입니다. 기본값은 줄당 16자·2줄·초당 14자·최소 1초·최대 7초이며 근거는 [오픈소스 통합](OPEN_SOURCE_INTEGRATIONS.md)의 자막 표시 규칙 기준에 있습니다. 숏폼 화면 측정 후 설정으로 조정합니다.
