...
- PR #38은 필요한 CI 전체 통과 후 #34 브랜치에 `51030ee`로 병합했습니다. #34의 이 새 HEAD에서 CI를 확인 중입니다. main 통합 PR #37은 초안 유지, 운영 재배포 없음.
...
- 다음: #34 최신 CI 후 원래 대상에 병합, #37 최신 CI·남은 CJK 경계/장시간 처리 위험 검토. 새 다국어 실제 대화·50% 기준 목소리·독립 음성/시각 검증은 여전히 남습니다. 다른 작업자 폴더와 비공개 runtime은 수정하지 않았습니다.
