...
**공정하게 견주면 시작 오차입니다: shift 0.030~0.500초, align 0.746~0.809초.** 이것만 보면 여전히 shift가 낫습니다. 다만 align의 시작 오차는 세 조건에서 거의 일정한데(0.746~0.809), shift는 조건에 따라 0.030에서 0.500까지 흔들립니다. 통째로 옮기기가 약한 조건이 더 있다면 뒤집힐 수 있습니다. 다음 실행이 `keep_duration`이 들어간 숫자를 냅니다.
