...
- main 통합 초안은 [PR #37](https://github.com/plutoan12/recording4/pull/37). 같은 head의 사전조건 수정 PR을 #34에 먼저 병합하고 #34 최신 CI를 확인할 것. 나머지 검토 과제는 `docs/MAIN_INTEGRATION.md` 참고.
